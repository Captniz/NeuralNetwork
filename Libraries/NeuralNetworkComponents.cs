...
using NeuralNetwork.Libraries.CustomExceptions;
using NeuralNetwork.Libraries.GlobalMethods;

namespace NeuralNetwork.Libraries.NeuralNetworkComponents
{
    public class Network
    {
        ...
        Layer[] layers;
        Network(int numberOfHiddenLayers, int[] numberOfNodesPerLayer)
        {
            /// <summary>
    ...
    class Node
    {
        ...
        public void calculate(double[] previousLayerValues)
        {
            ...
            this.value = MathMethods.sigmoid(tempValue + bias);
        }
        ...
        public void modBias(double biasVariation)
        {
            /// <summary>
            /// Gets the bias of the node.
            /// </summary>
